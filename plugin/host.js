// kb-rag DSH dynamic plugin — Host half (v1.6.3)
...
return {
  ...
  apply(ctx) {
    ...
    console.log('[kb-rag] tools registered (v1.6.3): kb_ingest / kb_search / kb_rag / kb_zotero / kb_dedup / kb_clear / kb_fetch / kb_scope / kb_stats')
  },
}
